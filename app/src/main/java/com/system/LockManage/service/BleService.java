package com.system.LockManage.service;
...
public class BleService extends Service {
    ...
    // 蓝牙已连接
    public final static String ACTION_GATT_CONNECTED = "com.system.LockManage.service.ACTION_GATT_CONNECTED";
    // 蓝牙已断开
    public final static String ACTION_GATT_DISCONNECTED = "com.system.LockManage.service.ACTION_GATT_DISCONNECTED";
    // 发现GATT服务
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.system.LockManage.service.ACTION_GATT_SERVICES_DISCOVERED";
    // 收到蓝牙数据
    public final static String ACTION_DATA_AVAILABLE = "com.system.LockManage.service.ACTION_DATA_AVAILABLE";
    // 连接失败
    public final static String ACTION_CONNECTING_FAIL = "com.system.LockManage.service.ACTION_CONNECTING_FAIL";
    // 蓝牙数据
    public final static String EXTRA_DATA = "com.system.LockManage.service.EXTRA_DATA";
