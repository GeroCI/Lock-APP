...
import com.system.LockManage.adapter.DeviceListAdapter;
import com.system.LockManage.service.BleService;
import com.system.LockManage.util.ByteUtils;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                ...
                case BleService.ACTION_GATT_DISCONNECTED:
                    Toast.makeText(BlueToothActivity.this, "蓝牙已断开", Toast.LENGTH_SHORT).show();
                    mBleService.release();
                    break;
